...
import sopt.study.testcode.geunpyo.spring.domain.stock.Stock;
import sopt.study.testcode.geunpyo.spring.domain.stock.StockRepository;
...
class OrderServiceTest {
	...
	@Test
	void
	createOrderWithDuplicateProductNumbers() {
		// given
		LocalDateTime registeredDateTime = LocalDateTime.now();
